...
if [ "$(uname)" == "Darwin" ]; then
    ...
    cd /Users/nadeyemi/Library/CloudStorage/OneDrive-NortheasternUniversity/Graduate/Research/Minn_MH_Sim_Projects/Patient_Routing_Optimization    
    conda activate bed_allocation_proj

    Rscript "src/envs/Simulations/sim_setup.R"  "$port" "$size" 
else
    ...
    cd /home/adeyemi.n/MH_Simulation/Patient_Routing_Optimization
